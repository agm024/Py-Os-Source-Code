...
theme='blue'
apps=["Terminal","TicTacToe","Python","Chrome","Firefox","Wikipedia","Settings","MyFiles"]
rapps=["Terminal","Tictactoe","Python","Chrome","Firefox","Wikipedia","Settings","Myfiles"]
